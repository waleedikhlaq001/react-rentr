		...
		<div className="px-2">
			<div className="border shadow rounded-xl p-4 grid md:grid-cols-2 grid-cols-1">
				...
				<div className="flex md:justify-end justify-center items-center gap-3 md:mt-0 mt-4">
					<div>
						<button className="border-2 text-sm text-gray-800 border-gray-800 rounded-full py-2 px-6">
							Pay full balance
						</button>
					</div>
					<div>
						<button className="border-0 text-gray-800 text-sm bg-[#EDEDEF] rounded-full py-2 px-6">
							Pay other amount
						</button>
					</div>
				</div>

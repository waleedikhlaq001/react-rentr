...
function ReviewDetails({ address, amount, onSubmit }) {
	...
	return (
		<div className="flex flex-col items-center bg-[#fafafa]">
			...
			<div className="fixed bottom-0 left-0 border-t md:border-t-0 right-0 px-4 py-4 w-full md:max-w-md md:bg-transparent bg-white shadow-lg md:static md:px-0 md:py-0 md:shadow-none">
				<button
					type="button"
